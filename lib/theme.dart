...
enum AppThemePreset {
  ...
  emerald(
    id: 'emerald',
    label: 'Emerald',
    description: 'Fresh and accomplished',
  ...
  tangerine(
    id: 'tangerine',
    label: 'Tangerine',
    description: 'Playful and productive',
  ...
  lilac(
    id: 'lilac',
    label: 'Lilac',
    description: 'Gentle and imaginative',
  ...
  meadow(
    id: 'meadow',
    label: 'Meadow',
    description: 'Bright and restorative',
    seed: Color(0xFF65A30D),
    icon: Icons.grass_rounded,
  ),
  charcoal(
    id: 'charcoal',
    label: 'Charcoal',
    description: 'Quiet and sophisticated',
    seed: Color(0xFF374151),
  ...
  peacock(
    id: 'peacock',
    label: 'Peacock',
    description: 'Distinctive and lively',
    seed: Color(0xFF0F766E),
  ...
  grape(
    id: 'grape',
    label: 'Grape',
    description: 'Expressive and deep',
...
ThemeData buildAppTheme({
  ...
  final scheme = base.colorScheme.copyWith(
    ...
    surfaceContainerLowest: generated.surfaceContainerLowest,
    surfaceContainerLow: generated.surfaceContainerLow,
    surfaceContainer: generated.surfaceContainer,
    surfaceContainerHigh: generated.surfaceContainerHigh,
    surfaceContainerHighest: generated.surfaceContainerHighest,
