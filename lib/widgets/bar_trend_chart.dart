...
/// - Automatically scales to the highest value
...
/// Custom painter used to render the bars.
class _BarTrendPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    // Prevent bars from becoming excessively wide.
    ...
    for (int i = 0; i < barCount; i++) {
      ...
      canvas.drawRRect(
        roundedRect.shift(const Offset(0, 3)),
        shadowPaint,
      );
  ...
  @override
  bool shouldRepaint(
    covariant _BarTrendPainter oldDelegate,
  ) {
